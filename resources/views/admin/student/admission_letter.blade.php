...
@section('section')
    <div class="py-2 container-fluid">
        ...
        <div style="font-size: large;">
            ...
            <div class="my-2 py-1">
                <p>{!! __('text.admission_letter_text_block1', ['degree'=>$degree??'DEG', 'department'=>$program?:$fee['program']??'PROG', 'matric'=>$matric ,'start_of_lectures'=>$start_of_lectures, 'school_email'=>$school_email, 'campus' => $campus??'MILE 17']) !!}</p>
                <ul class="arrow-list">
